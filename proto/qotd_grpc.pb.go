...
func (c *qOTDClient) GetQOTD(ctx context.Context, in *GetReq, opts ...grpc.CallOption) (*GetResp, error) {
	...
	out := new(GetResp)
	err := c.cc.Invoke(ctx, QOTD_GetQOTD_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedQOTDServer must be embedded to have
...
func (UnimplementedQOTDServer) testEmbeddedByValue()              {}
...
func RegisterQOTDServer(s grpc.ServiceRegistrar, srv QOTDServer) {
	// If the following call pancis, it indicates UnimplementedQOTDServer was
